...
## TF04.0 — Schema: json + subfields on echo columns
**Status**: done
...
## TF04.3 — Column expansion in the manager/config
**Status**: done
...
## TF04.4 — Omitted subfields = all top-level keys
**Status**: done
...
## TF04.5 — Feature test suite + demo verification
...
message.
**Description**: TF04.0–TF04.4 pass together; run the demo against a JSON-string
