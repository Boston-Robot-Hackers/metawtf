...
## TF05.0 (done) — Lexer: lines to (directive, positional, options)
**Status**: done
...
## TF05.1 (done) — Directives and string-based validators
**Status**: done
...
## TF05.2 (done) — load_config, CLI, and packaging
**Status**: done
...
## TF05.3 (done) — Convert configs and docs
**Status**: done
...
## TF05.4 (done) — Feature test suite
**Status**: done
